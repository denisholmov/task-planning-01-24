...
# Стек
- Стейтменеджеры - **[Tanstack Query](https://tanstack.com/query/latest), [Zustand](https://zustand.docs.pmnd.rs/getting-started/introduction)**
- Работа с формами - **[react-hook-form](https://www.npmjs.com/package/react-hook-form), [yup](https://www.npmjs.com/package/yup)**
- Сборка **[Vite](https://vite.dev/guide/)**
- Ui библиотека - **[Mantine UI](https://ui.mantine.dev/)** 
- Роуты - **[React Router DOM](https://reactrouter.com/home)**
